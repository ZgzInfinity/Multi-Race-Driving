...
SoundPlayer::SoundPlayer(const int volMusic, const int volEffects){
    ...
    titleSoundtracks[2] = "WINNING ROAD";      titleSoundtracks[7] = "SOUND MAGICAL SHOWER";
    titleSoundtracks[3] = "BLUEGRASS BOGGIE";  titleSoundtracks[8] = "PASSING BREZZE";
    titleSoundtracks[4] = "DEADWOOD RIDING";   titleSoundtracks[9] = "SPLASH WAVE";
