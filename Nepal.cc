 ...
 */
void Antarctica::loadBackground(){
    bg.loadFromFile("images/Nepal/background.png");
 ...
 */
void Antarctica::renderLandScape(vector<Step>& lines, Sprite object[]){
 ...
 */
void Antarctica::loadSprites(Texture t[], Sprite object[]){
    // Load textures and sprites of the game
    t[0].loadFromFile("images/Nepal/palm_tree.png");
    t[0].setSmooth(true);
    object[0].setTexture(t[0]);

    t[1].loadFromFile("images/Nepal/palm_tree_inverted.png");
    t[1].setSmooth(true);
    object[1].setTexture(t[1]);

    t[3].loadFromFile("images/Nepal/dry_tree.png");
    t[3].setSmooth(true);
    object[3].setTexture(t[3]);

    t[4].loadFromFile("images/Nepal/dry_tree2.png");
    t[4].setSmooth(true);
    object[4].setTexture(t[4]);

    t[5].loadFromFile("images/Nepal/cactus.png");
    t[5].setSmooth(true);
    object[5].setTexture(t[5]);

    t[6].loadFromFile("images/Nepal/dry_tree3.png");
    t[6].setSmooth(true);
    object[6].setTexture(t[6]);

    t[7].loadFromFile("images/Nepal/elephant.png");
    t[7].setSmooth(true);
    object[7].setTexture(t[7]);

    t[8].loadFromFile("images/Nepal/camel.png");
    t[8].setSmooth(true);
    object[8].setTexture(t[8]);

    t[9].loadFromFile("images/Nepal/iglu.png");
    t[9].setSmooth(true);
    object[9].setTexture(t[9]);

    t[10].loadFromFile("images/Nepal/signal_go.png");
    t[10].setSmooth(true);
    object[10].setTexture(t[10]);

    t[11].loadFromFile("images/Nepal/signal_bus.png");
    t[11].setSmooth(true);
    object[11].setTexture(t[11]);

    t[12].loadFromFile("images/Nepal/signal_50.png");
    t[12].setSmooth(true);
 ...
 */
void Antarctica::printSpritesInScene(Step& line, Sprite object[], const int i){
 ...
 */
void Antarctica::printMountains(Step& line, const int i){
 ...
 */
void Antarctica::printCurves(Step& line, const int i){
    // First curve
    if (i >= 50 && i <= 100){
 ...
 */
void Antarctica::paintScene(const int n, Color& grass, Color& rumble, Color& middle, Color& road){
 ...
 */
void Nepal::orderSpritesInLandScape(){
 ...
 */
Step Antarctica::checkingPossibleCollision(const int position_axis_Y){
 ...
 */
void Antarctica::lookForCurve( int& pos, IntervalCurve& curve, bool& exist){
