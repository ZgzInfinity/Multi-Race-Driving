...
void SherwoodForest::loadBackground(){
    bg.loadFromFile("images/SherwoodForest/bg.png");
...
void SherwoodForest::loadSprites(Texture t[], Sprite object[]){
    ...
    t[0].loadFromFile("images/SherwoodForest/fir_tree.png");
    t[0].setSmooth(true);
    object[0].setTexture(t[0]);

    t[1].loadFromFile("images/SherwoodForest/green_tree.png");
    t[1].setSmooth(true);
    object[1].setTexture(t[1]);

    t[3].loadFromFile("images/SherwoodForest/green_tree2.png");
    t[3].setSmooth(true);
    object[3].setTexture(t[3]);

    t[4].loadFromFile("images/SherwoodForest/green_tree3.png");
    t[4].setSmooth(true);
    object[4].setTexture(t[4]);

    t[5].loadFromFile("images/SherwoodForest/bush.png");
    t[5].setSmooth(true);
    object[5].setTexture(t[5]);

    t[6].loadFromFile("images/SherwoodForest/petrol_station.png");
    t[6].setSmooth(true);
    object[6].setTexture(t[6]);

    t[7].loadFromFile("images/SherwoodForest/cow_up.png");
    t[7].setSmooth(true);
    object[7].setTexture(t[7]);

    t[8].loadFromFile("images/SherwoodForest/cow_down.png");
    t[8].setSmooth(true);
    object[8].setTexture(t[8]);

    t[9].loadFromFile("images/SherwoodForest/windmolen.png");
    t[9].setSmooth(true);
